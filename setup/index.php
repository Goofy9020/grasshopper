        ...
        subPanelBuilder: function (cell, uniqueIndex) {
            ...
            subgrid.appendGrid({
                ...
                columns: [
                    ...
                    { name: 'controlpointtype', display: 'Type', ctrlCss: { 'width': '150px'}, type: 'select', ctrlOptions: { 0: 'Light on-off', 1: 'Light dimmable', 2: 'Motorised Screens', 3: 'Push-button', 4: 'Command', 5: 'Radio', 6: 'Source'} }
                ],
                initData: [
                    {
                          controlpointtype: 0
